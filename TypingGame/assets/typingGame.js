 ...
 //bool to track typing an entire LINE without a mistake
  ...
  return{
    ...
    newLevel: function(){
      level++;
      //added 'assets'
      document.getElementById('outerEdge').style.backgroundImage = 'url("assets/level_' + level + '.gif")';
    },
    clear: function(){
      round = 0;
      score = 0;
...
var fighter = (function(){
 ...
 imgFighter.src = "assets/greenFighter.png";
...
var boss = (function(){
  ...
  //added 'assets' to path
  imgBoss.src = "assets/greenBoss.png";
...
// length of quiz is 4 answers
  ...
  return{
    make: function(){
      ...
      quizArr.sort(function(a, b){return a.order > b.order;}); // pulled the correct answer first, have to shuffle it.
